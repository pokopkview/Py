...
public class CycleViewPager extends Fragment implements ViewPager.OnPageChangeListener {
	...
	private List<APPqueryCommodityBean.ObjectBean.CommoditypicturesBean> infos1;
	@Override
	...
	public void setData(List<ImageView> views, List<APPHomePageBean.ObjectBean.PicturesBean> list, ImageCycleViewListener listener) {
		setData(views, list, listener, 0);
	}

	public void setData1(List<ImageView> views, List<APPqueryCommodityBean.ObjectBean.CommoditypicturesBean> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData1(List<ImageView> views, List<APPqueryCommodityBean.ObjectBean.CommoditypicturesBean> list, ImageCycleViewListener listener, int showPosition) {
