...
public class CycleViewPager1 extends Fragment implements ViewPager.OnPageChangeListener {
	...
	private BaseViewPager1 parentViewPager;
	...
	public void setData(List<ImageView> views, List<APPqueryCommodityBean.ObjectBean.CommoditypicturesBean> list, ImageCycleViewListener listener) {
