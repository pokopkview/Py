 ...
 * 搜索结果 商品展示
 */
public class SSearchAdapter extends BaseAdapter {
    private Context context;
    APPqueryHistorySeekByIDShopBean data ;

    public SSearchAdapter(Context context, APPqueryHistorySeekByIDShopBean data ) {
